        ...
        <div class="billing-mode-only-item">
            <span class="pull-left">
                <h3><b><?php echo e(cleanLang(__('lang.estimate'))); ?> | <?php echo e($bill->formatted_bill_estimateid); ?></b>
                    <!--automation icon-->
            ...
            <!--status-->
            <span style="margin-left: 20%" class="pull-right">
                <!--draft-->
...
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/bill/components/elements/estimate/header-web.blade.php ENDPATH**/ ?>