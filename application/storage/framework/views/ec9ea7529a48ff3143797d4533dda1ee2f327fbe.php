                ...
                <div>
                    <?php $__currentLoopData = $project->assigned; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span data-toggle="tooltip" title="<?php echo e($team->first_name); ?> <?php echo e($team->last_name); ?>"><img
                                src="<?php echo e(getUsersAvatar($team->avatar_directory, $team->avatar_filename)); ?>"
                                alt="user" class="img-circle avatar-xsmall"></span>
                        ...
                        <div>
                            <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span data-toggle="tooltip"
                                    title="<?php echo e($contact->first_name); ?> <?php echo e($contact->last_name); ?>"><img
                                        src="<?php echo e(getUsersAvatar($contact->avatar_directory, $contact->avatar_filename)); ?>"
                                        alt="user" class="img-circle avatar-xsmall"></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<!--                </div>-->
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <?php if($project->project_billing_costs_estimate > 0): ?>
                <tr>
            <td class="p-l-0 p-t-5"><?php echo e(cleanLang(__('lang.costs_estimate'))); ?></td>
            <td class="font-medium p-r-0 p-t-5">
                <?php echo e(runtimeMoneyFormat($project->project_billing_costs_estimate - $project->sum_invoices_all )); ?>

                <div class="progress">
                    <div class="progress-bar bg-info <?php echo e(runtimeProjectInvoicesBars($project->project_billing_costs_estimate, $project->sum_invoices_all )); ?>"
                        role="progressbar"></div>
                </div>
            </td>
        </tr>
        ...
        <div class="row">
                            ...
                            <div>
                                <div class="panel-label p-b-3"><?php echo e(cleanLang(__('lang.costs_estimate'))); ?></div>
                                <div><?php echo e(runtimeMoneyFormat($project->project_billing_costs_estimate)); ?></div>
                            </div>
        ...
        <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($field->customfields_show_project_page == 'yes'): ?>
                <div class="x-each-field m-b-18">
                    ...
                    <div class="x-content"><?php echo clean(customFieldValue($field->customfields_name, $project, $field->customfields_datatype)); ?></div>
                </div>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<!-- Column -->
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>