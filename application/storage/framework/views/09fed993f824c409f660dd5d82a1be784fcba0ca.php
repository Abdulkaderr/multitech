    ...
    <tr id="estimate_<?php echo e($estimate->bill_estimateid); ?>">
        ...
        <td class="estimates_col_id" id="estimates_col_id_<?php echo e($estimate->bill_estimateid); ?>">
            ...
            <?php if(auth()->user()->is_team && $estimate->estimate_automation_status == 'enabled'): ?>
                <span class="sl-icon-energy text-warning p-l-5" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.estimate_automation'); ?>"></span>
            <?php endif; ?>
        </td>
        ...
        <?php if(config('visibility.estimates_col_tags')): ?>
            <td class="estimates_col_tags" id="estimates_col_tags_<?php echo e($estimate->bill_estimateid); ?>">
                ...
                <?php if(count($estimate->tags ?? []) > 0): ?>
                    <span
                        class="label label-outline-default"><?php echo e(str_limit($estimate->tags->first()->tag_title, 15)); ?></span>
                <?php else: ?>
                    <span>---</span>
                <?php endif; ?>
                <!--/#tag-->
        ...
        <td class="estimates_col_status" id="estimates_col_status_<?php echo e($estimate->bill_estimateid); ?>">
            <span
                class="label <?php echo e(runtimeEstimateStatusColors($estimate->bill_status, 'label')); ?>"><?php echo e(runtimeLang($estimate->bill_status)); ?></span>
            ...
            <td class="estimates_col_action actions_column" id="estimates_col_action_<?php echo e($estimate->bill_estimateid); ?>">
                ...
                <span class="list-table-action dropdown font-size-inherit">
                    ...
                    <?php if(config('visibility.action_buttons_edit')): ?>
                        <a href="/estimates/<?php echo e($estimate->bill_estimateid); ?>/edit-estimate"
                    ...
                    <span class="list-table-action dropdown  font-size-inherit">
                        ...
                        <div class="dropdown-menu" aria-labelledby="listTableAction">
                            ...
                            <a class="dropdown-item"
                                href="<?php echo e(url('/estimates/view/' . $estimate->bill_uniqueid . '?action=preview')); ?>"
...
<!--each row-->
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/estimates/components/table/ajax.blade.php ENDPATH**/ ?>