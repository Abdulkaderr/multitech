...
<!--Omar Ahmed -->
    <td class="items_col_img" id="items_col_img_<?php echo e($item->item_id); ?>">
        <?php if(isset($attachments) && $attachments->isNotEmpty()): ?>
            <?php
                $attachment = $attachments->where('attachmentresource_id', $item->item_id)->first();
            ?>
            <?php if($attachment): ?>
                <img src="<?php echo e(asset("storage/files/{$attachment->attachment_directory}/{$attachment->attachment_thumbname}")); ?>" 
                     alt="Item Image">
            <?php else: ?>
                No Image Found
            <?php endif; ?>
...
<!--each row--><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/items/components/table/ajax.blade.php ENDPATH**/ ?>