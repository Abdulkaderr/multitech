    ...
    <tr id="invoice_<?php echo e($invoice->bill_invoiceid); ?>">
        ...
        <?php if(config('visibility.invoices_col_client')): ?>
            <td class="invoices_col_company" id="invoices_col_company_<?php echo e($invoice->bill_invoiceid); ?>">
                <a
                    href="/clients/<?php echo e($invoice->bill_clientid); ?>"><?php echo e(str_limit($invoice->client_company_name ?? '---', 12)); ?></a>
            </td>
        <?php endif; ?>
        <?php if(config('visibility.invoices_col_project')): ?>
            <td class="invoices_col_project" id="invoices_col_project_<?php echo e($invoice->bill_invoiceid); ?>">
                <a
                    href="/projects/<?php echo e($invoice->bill_projectid); ?>"><?php echo e(str_limit($invoice->project_title ?? '---', 12)); ?></a>
            </td>
        <?php endif; ?>
        ...
        <td class="invoices_col_status" id="invoices_col_status_<?php echo e($invoice->bill_invoiceid); ?>">
            ...
            <span
                class="label <?php echo e(runtimeInvoiceStatusColors($invoice->bill_status, 'label')); ?>"><?php echo e(runtimeLang($invoice->bill_status)); ?></span>
            ...
            <?php if(config('system.settings_estimates_show_view_status') == 'yes' &&
                    auth()->user()->is_team &&
                    $invoice->bill_status != 'draft' &&
        ...
        <td class="invoices_col_action actions_column" id="invoices_col_action_<?php echo e($invoice->bill_invoiceid); ?>">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <?php if(config('visibility.action_buttons_edit')): ?>
                    <a href="/invoices/<?php echo e($invoice->bill_invoiceid); ?>/edit-invoice"
                        title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                    ...
                    <span class="list-table-action dropdown font-size-inherit">
                        ...
                        <div class="dropdown-menu" aria-labelledby="listTableAction">
                            <?php if(config('visibility.action_buttons_edit')): ?>
                                ...
                                <!--    href="<?php echo e(url('/invoices/view/' . $invoice->bill_invoiceid . '?action=preview')); ?>"-->
                                <!--    target="_blank"><?php echo app('translator')->get('lang.invoice_url'); ?></a>-->
...
<!--each row-->
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>