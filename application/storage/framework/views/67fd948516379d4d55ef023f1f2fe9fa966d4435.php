    ...
    <div class="col-lg-12">
                    ...
                    <select class="select2-basic form-control form-control-sm" id="client_categoryid"
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->category_id); ?>"
                                <?php echo e(runtimePreselected($client->client_categoryid ?? '', $category->category_id)); ?>>
        ...
        <?php if(auth()->user()->is_team): ?>
            ...
            <div class="hidden" id="edit_client_description_toggle">
                ...
                <textarea id="client_description" name="client_description" class="tinymce-textarea"><?php echo e($client->client_description ?? ''); ?></textarea>
...
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>