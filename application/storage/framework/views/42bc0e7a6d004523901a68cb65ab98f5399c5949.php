<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <textarea class="w-100" id="item_description" rows="5" name="item_description"><?php echo e($item->item_description ?? ''); ?></textarea>
            </div>
        </div>
                ...
                <select class="select2-basic form-control form-control-sm" id="item_categoryid" name="item_categoryid">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->category_id); ?>"
                            <?php echo e(runtimePreselected($item->item_categoryid ?? '', $category->category_id)); ?>>
        ...
        <div class="hidden p-t-10" id="item_notes_estimatation_panel">
            <div class="form-group row">
                <div class="col-sm-12">
                    <textarea class="form-control form-control-sm tinymce-textarea-plain" rows="5" name="item_notes_estimatation"
        ...
        <div class="spacer row">
            <div class="col-sm-12 col-lg-8">
                <span class="title">Upload a File: </span class="title">
            </div>
            <div class="col-sm-12 col-lg-4">
                <div class="switch  text-right">
                    <label>
        ...
        <div class="hidden" id="add_expense_attach_receipt">
            ...
            <div class="form-group row">
                <div class="col-sm-12">
                    <div class="dropzone dz-clickable" id="fileupload_item_attachment">
                ...
                <table class="table table-bordered">
                    <tbody>
                        <?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="item_attachment_<?php echo e($attachment->attachment_id); ?>">
                                ...
                                <td class="w-px-40"> <button type="button"
                                        ...
                                        data-url="<?php echo e(url('/items/attachments/' . $attachment->attachment_uniqiueid)); ?>">
        ...
        <div class="form-group row hidden">
            <label class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.production_notes'); ?></label>
            <div class="col-sm-12 ">
                <textarea class="form-control form-control-sm tinymce-textarea-plain" rows="5" name="item_notes_production"
...
</div><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/items/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>