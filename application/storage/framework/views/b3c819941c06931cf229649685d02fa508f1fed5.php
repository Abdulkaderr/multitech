<div id="js-projects-modal-add-edit" data-project-progress="<?php echo e($project['project_progress'] ?? 0); ?>">
    <div class="form-group form-group-checkbox row">
        ...
        <div class="col-2 text-left p-t-5">
            <input type="checkbox" id="project_progress_manually" name="project_progress_manually"
                ...
                <?php echo e(runtimePrechecked($project['project_progress_manually'] ?? '')); ?> checked>
    ...
    <div class="modal-selector  m-t-20">
        ...
        <input type="hidden" name="project_progress" value="<?php echo e($project->project_progress ?? ''); ?>" id="project_progress" />
    </div>
...
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/projects/components/actions/change-progress.blade.php ENDPATH**/ ?>