<div class="row">
    <div class="col-lg-12">
        ...
        <!--<div class="form-group row">-->
            ...
            <!--<div class="col-sm-12 col-lg-9">-->
                <input type="text" class="form-control form-control-sm hidden" id="first_name " name="first_name"
        ...
        <!--<div class="form-group row">-->
            ...
            <!--<div class="col-sm-12 col-lg-9">-->
                <input type="text" class="form-control form-control-sm hidden" id="last_name" name="last_name"
        ...
        <!--<div class="form-group row">-->
            ...
            <!--<div class="col-sm-12 col-lg-9">-->
                <input type="text" class="form-control form-control-sm hidden" id="phone" name="phone"
        ...
        <!--<div class="form-group row">-->
            ...
            <!--<div class="col-sm-12 col-lg-9">-->
                <input type="text" class="form-control form-control-sm hidden" id="position" name="position"
...
</div><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/contacts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>