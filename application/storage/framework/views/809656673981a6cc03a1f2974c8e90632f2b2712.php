            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item hidden-xs-down search-box hidden">
                    ...
                    <form class="app-search">
                        <input type="text" class="form-control" id="top-search-form" name="top_search" placeholder="<?php echo app('translator')->get('lang.search'); ?>">
                        <a class="srh-btn">
                            <i class="ti-close"></i>
                        </a>
                    </form>
...
</header><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>