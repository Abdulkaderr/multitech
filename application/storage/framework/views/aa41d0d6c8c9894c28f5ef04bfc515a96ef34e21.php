    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="r-panel-body">
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.year'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_year" id="filter_year"
                                    ...
                                    data-preselected="<?php echo e(request('filter_year') ?? now()->year); ?>"
                                    data-width="resolve">
                                    <option value=""><?php echo e(cleanLang(__('lang.select'))); ?></option>
                                    <?php for($year = now()->year; $year >= now()->year - 7; $year--): ?>
                                    <option value="<?php echo e($year); ?>" <?php echo e(runtimePreselected(request('filter_year'), $year)); ?>><?php echo e($year); ?></option>
                                    <?php endfor; ?>
                                    <option value="all" <?php echo e(runtimePreselected(request('filter_year'), 'all')); ?>><?php echo e(cleanLang(__('lang.all'))); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<!--sidebar--><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/expenses/components/misc/filter-expenses.blade.php ENDPATH**/ ?>