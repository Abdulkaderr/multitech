        ...
        <div class="row">
            ...
            <div class="col-12 m-b-10 billing-mode-only-item">
                ...
                <div class="pull-left">
                    <address>
                        ...
                        <!--<?php if($bill->bill_type == 'invoice'): ?>-->
                        <!--    <h5> <strong><?php echo e(cleanLang(__('lang.invoice'))); ?> | <?php echo e($bill->formatted_bill_invoiceid); ?></strong></h5> -->
                        <!--<?php elseif($bill->bill_type = 'estimate'): ?>-->
                        <!--    <h5> <strong><?php echo e(cleanLang(__('lang.estimate'))); ?> |<?php echo e($bill->formatted_bill_estimateid); ?></strong></h5>-->
                        <!--<?php endif; ?>-->
                </div>
                <!--client address-->
            ...
            <?php if(auth()->check() && auth()->user()->is_team && !config('visibility.public_bill_viewing')): ?>
                <?php if(config('visibility.bill_mode') == 'viewing'): ?>
                    <div class="card card-body invoice-wrapper billing-mode-only-item billing-mode-only-item"
                        id="invoice-wrapper">
                        <h4 class="">Details <span
                    ...
                    <!--<div class="card card-body invoice-wrapper billing-mode-only-item billing-mode-only-item"-->
                    <!--    id="invoice-wrapper">-->
                    <!--    <h4 class=""><?php echo e(cleanLang(__('lang.terms_and_conditions'))); ?> <span-->
                    <!--            class="align-middle text-themecontrast font-16" data-toggle="tooltip"-->
                    <!--            title="<?php echo e(cleanLang(__('lang.not_visisble_to_client'))); ?>" data-placement="top"><i-->
                    <!--                class="ti-info-alt"></i></span></h4>-->
                    <!--    <div><?php echo clean($bill->bill_notes); ?></div>-->
                ...
                <?php if(config('visibility.bill_mode') == 'editing'): ?>
                    <div class="card card-body invoice-wrapper billing-mode-only-item" id="invoice-wrapper">
                        <h4 class=""><?php echo e(cleanLang(__('lang.terms_and_conditions'))); ?> <span
                                class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                                title="<?php echo e(cleanLang(__('lang.not_visisble_to_client'))); ?>" data-placement="top"><i
                                    class="ti-info-alt"></i></span></h4>
...
<?php endif; ?>
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/bill/bill-web.blade.php ENDPATH**/ ?>