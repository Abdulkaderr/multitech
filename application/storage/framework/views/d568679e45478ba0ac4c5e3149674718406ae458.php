                ...
                <table id="items-list-table" class="table m-t-0 m-b-0 table-hover no-wrap item-list" data-page-size="10">
                    <thead>
                        <tr>
                            ...
                            <!--Omar Ahmed -->
                            <th class="items_col_image">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_item_image"
                                    >
                                    Product Image
                                </a>
                            </th>
                            ...
                            <?php if(config('visibility.items_col_category')): ?>
                                <th class="items_col_category"><a class="js-ajax-ux-request js-list-sorting"
                    ...
                    <tbody id="items-td-container">
                        ...
                        <input type="hidden" name="checkbox_actions_items_category"
                            id="checkbox_actions_items_category">
                    </tbody>
                      <tr>
                        <td colspan="20">
                            <!--load more button-->
...
</div><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/items/components/table/table.blade.php ENDPATH**/ ?>