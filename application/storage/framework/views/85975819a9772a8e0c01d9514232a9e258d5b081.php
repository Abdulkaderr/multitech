...
<tr id="contract_<?php echo e($contract->doc_id); ?>">
    ...
    <td class="contracts_col_action actions_column" id="contracts_col_action_<?php echo e($contract->doc_id); ?>">
     ...
     <!--contract url mohamed-->
                                <!--<a class="dropdown-item"-->
                                <!--    href="<?php echo e(url('/contracts/view/' . $contract->doc_unique_id . '?action=preview')); ?>"-->
                                <!--    target="_blank"><?php echo app('translator')->get('contract url'); ?></a>-->
                    <!--clone contract-->
...
<!--each row--><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/contracts/components/table/ajax.blade.php ENDPATH**/ ?>