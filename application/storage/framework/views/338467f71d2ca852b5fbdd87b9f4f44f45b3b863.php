...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <!--YEAR SELECTOR-->
        <form method="get" action="<?php echo e(urlResource('/expenses')); ?>" class="list-actions-button form-group mb-0">
            <?php $selectedYear = request('filter_year') ?? now()->year; ?>
            <label for="expense_year_selector" class="d-none"><?php echo e(cleanLang(__('lang.year'))); ?></label>
            <select name="filter_year" id="expense_year_selector" class="form-control form-control-sm" autocomplete="off" onchange="this.form.submit();">
                <option value=""><?php echo e(cleanLang(__('lang.year'))); ?></option>
                <option value="all" <?php if($selectedYear == 'all'): ?> selected <?php endif; ?>><?php echo e(cleanLang(__('lang.all'))); ?></option>
                <?php for($year = now()->year; $year >= now()->year - 7; $year--): ?>
                <option value="<?php echo e($year); ?>" <?php if($selectedYear == $year): ?> selected <?php endif; ?>><?php echo e($year); ?></option>
                <?php endfor; ?>
            </select>
        </form>
...
</div><?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/expenses/components/misc/list-page-actions.blade.php ENDPATH**/ ?>