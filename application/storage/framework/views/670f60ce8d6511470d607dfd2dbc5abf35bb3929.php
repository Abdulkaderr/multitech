<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>"
        ...
        <?php if(config('visibility.project_modal_client_fields')): ?>
            <div class="client-selector">
                ...
                <div class="client-selector-container hidden" id="client-new-container">
                    ...
                    <input type="hidden" class="form-control form-control-sm" id="last_name" name="last_name"
                        value="Last Name" placeholder="">
  ...
  <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    ...
                    <div id="add_client_billing_address_section">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-lg-9">
                                <input type="text" class="form-control form-control-sm" id="client_vat"
                                    name="client_vat" value="<?php echo e($client->client_vat ?? ''); ?>">
                            </div>
                        </div>
                        <div class="line"></div>
                    </div>
        ...
        <?php if($page['section'] == 'create'): ?>
            ...
            <!--                        data-id="<?php echo e($template->project_id); ?>"-->
            <!--                        data-title="<?php echo e($template->project_title); ?>"-->
            ...
            <!--                        data-title="<?php echo e($template->project_title); ?>"><?php echo e($template->project_title); ?>-->
            <!--                    </option>-->
        ...
        <?php if(config('mode.create') && config('system.settings2_projects_automation_default_status') == 'enabled'): ?>
            <div class="form-group form-group-checkbox row">
                <label class="col-10 col-form-label text-left"><?php echo app('translator')->get('lang.automation'); ?> <span
                        class="align-middle text-info font-16" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.apply_default_automation_project'); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
        ...
        <div class="" id="edit_project_setings">
            ...
            <?php if(auth()->user()->role->role_projects_billing == 2): ?>
                ...
                <div class="" id="edit_project_billing">
                    <div class="highlighted-panel">
                        ...
                        <!--        <div class="alert alert-info"><?php echo e(cleanLang(__('lang.project_estimated_hours_info'))); ?>-->
                        <!--        </div>-->
                        <!--    </div>-->
                        <!--</div>-->
                        <!--cost estimate-->
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-sm-12 col-lg-4">
                                <input type="number" class="form-control form-control-sm"
                                    ...
                                    placeholder="" value="<?php echo e($project['project_billing_costs_estimate'] ?? ''); ?>">
                            </div>
                            <div class="collapse col-sm-12 m-t-15" id="project_cost_estimate_info">
                                <div class="alert alert-info"><?php echo e(cleanLang(__('lang.project_cost_estimate_info'))); ?>
            ...
            <?php if(config('visibility.project_modal_project_permissions')): ?>
                ...
                <div class="hidden highlighted-panel" id="edit_project_assigned_permissions">
                    <div class="form-group form-group-checkbox row m-b-0">
                        <label class="col-5 col-form-label text-left"><?php echo e(cleanLang(__('lang.task_collaboration'))); ?>
                ...
                <div id="edit_project_permissions_tasks" class="hidden highlighted-panel">
                    ...
                    <div><small class="text-bold">**
                            <?php echo e(cleanLang(__('lang.if_items_selected_then_viewing_perm'))); ?></small>
                    </div>
                    <div class="line m-t-30"></div>
                </div>
                <!--/#CLIENT PERMISSIONS-->
...
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>