<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr id="project_<?php echo e($project->project_id); ?>">
        ...
        <!--tableconfig_column_23 [net_profit]-->
        <td class="col_net_profit">
            <?php echo e(runtimeMoneyFormat(($project->sum_invoices_all ?? 0) - ($project->sum_expenses ?? 0))); ?>
                    ...
                    <?php if(config('visibility.action_buttons_edit')): ?>
                        <?php if($project->permission_edit_project): ?>
                            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                                ...
                                data-modal-title="<?php echo e(cleanLang(__('lang.edit_project'))); ?>"
                                data-action-url="<?php echo e(urlResource('/projects/' . $project->project_id)); ?>"
                        ...
                        <?php if(auth()->user()->role->role_assign_projects == 'yes'): ?>
                            <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                                ...
                                data-action-method="PUT" data-modal-size="modal-sm"
                                data-action-ajax-class="ajax-request" data-action-ajax-class=""
                                data-action-ajax-loading-target="projects-td-container">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row-->
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>