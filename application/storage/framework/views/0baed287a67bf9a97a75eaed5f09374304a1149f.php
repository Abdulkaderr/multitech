                ...
                <div class="create-modal-body">
                        ...
                        <div class="x-option">
                            <div class="form-group form-group-checkbox row">
                                <input name="group5" type="radio" id="client_type_new"
                                    ...
                                    class="with-gap radio-col-blue create-modal-selector">
                                <label for="client_type_new"><span class="x-label-text"><?php echo app('translator')->get('lang.new_client'); ?></span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="create-modal-section section-right" id="create-modal-section-right">
                        ...
                        <div id="option-existing-client-container" class="create-modal-option-contaiers hidden">
                            ...
                            <div class="text-right p-t-30">
                                <button type="submit" id="submitButton"
                                    ...
                                    data-loading-target="create-modal-section-right" disabled><?php echo app('translator')->get('lang.continue'); ?></button>
                            </div>
                        </div>
                        ...
                        <div id="option-new-client-container" class="create-modal-option-contaiers">
                            ...
                            <!--[dynamic button]-->
                            <span class="hidden edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                                id="create-new-client-dynamic-button" data-toggle="modal" data-target="#commonModal"
                                data-url="--dynamic--" data-loading-target="commonModalBody"
                                data-modal-title="--dynamic--" data-action-url="--dynamic--" data-action-method="POST"
...
<?php /**PATH /home/u446360577/domains/multitech-mt.nl/public_html/my/application/resources/views/modals/create.blade.php ENDPATH**/ ?>