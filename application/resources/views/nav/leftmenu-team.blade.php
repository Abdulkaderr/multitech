...
<aside class="left-sidebar" id="js-trigger-nav-team">
     ...
     <!-- Customers -->
                ...
                <li data-modular-id="main_menu_team_clients"
                    ...
                    <a class="waves-effect waves-dark" href="/clients" aria-expanded="false" target="_self">
                        <i class="ti-user"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.clients')) }}</span>
                    </a>
                    @endif
                </li>
                @endif
 ...
 <!--projects[done]-->
                ...
                <!-- Sales -->
                @if(runtimeGroupMenuVibility([config('visibility.modules.invoices'), config('visibility.modules.estimates'), config('visibility.modules.subscriptions'), config('visibility.modules.expenses'), config('visibility.modules.products')]))
                <!-- Invoices -->
                @if(config('visibility.modules.invoices'))
                <li data-modular-id="main_menu_team_invoices"
                    class="sidenav-menu-item {{ $page['mainmenu_invoices'] ?? '' }} menu-tooltip menu-with-tooltip"
                    title="{{ cleanLang(__('lang.invoices')) }}">
                    <a class="waves-effect waves-dark" href="/invoices" aria-expanded="false" target="_self">
                        <i class="ti-receipt"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.invoices')) }}</span>
                    </a>
                </li>
                @endif
                <!-- Estimates -->
                ...
                <li data-modular-id="main_menu_team_estimates"
                    class="sidenav-menu-item {{ $page['mainmenu_estimates'] ?? '' }} menu-tooltip menu-with-tooltip"
                    title="{{ cleanLang(__('lang.estimates')) }}">
                    <a class="waves-effect waves-dark" href="/estimates" aria-expanded="false" target="_self">
                        <i class="ti-clipboard"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.estimates')) }}</span>
                    </a>
                </li>
                @endif
                <!-- Subscriptions -->
                ...
                <li data-modular-id="main_menu_team_subscriptions"
                    class="sidenav-menu-item {{ $page['mainmenu_subscriptions'] ?? '' }} menu-tooltip menu-with-tooltip"
                    title="{{ cleanLang(__('lang.subscriptions')) }}">
                    <a class="waves-effect waves-dark" href="/subscriptions" aria-expanded="false" target="_self">
                        <i class="ti-reload"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.subscriptions')) }}</span>
                    </a>
                </li>
                @endif
                <!-- Expenses -->
                ...
                <li data-modular-id="main_menu_team_expenses"
                    ...
                    <a class="waves-effect waves-dark" href="/expenses" aria-expanded="false" target="_self">
                        <i class="ti-money"></i>
                        <span class="hide-menu">{{ cleanLang(__('lang.expenses')) }}</span>
                    </a>
                </li>
                @endif
                <!-- Products -->
                ...
                <li data-modular-id="main_menu_team_products"
                    ...
                    <a class="waves-effect waves-dark" href="/products" aria-expanded="false" target="_self">
                        ...
                        <span class="hide-menu">{{ cleanLang(__('lang.products')) }}</span>
                    </a>
                </li>
                @endif
                @endif
                ...
                <li data-modular-id="main_menu_team_team"
                    ...
                    <ul aria-expanded="false" class="position-top collapse">
                        ...
                        <li class="sidenav-submenu mainmenu_settings {{ $page['submenu_settings'] ?? '' }}"
                            ...
                            <a href="/settings"
                                class="{{ $page['submenu_settings'] ?? '' }}">E-mails verzonden</a>
