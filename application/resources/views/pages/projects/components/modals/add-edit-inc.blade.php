<div class="row" id="js-projects-modal-add-edit" data-section="{{ $page['section'] }}"
  ...
  <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-lg-9">
                                <input type="text" class="form-control form-control-sm" id="client_vat"
                                    name="client_vat" value="{{ $client->client_vat ?? '' }}">
                            </div>
                        </div>
                        <div class="line"></div>
                    </div>
        ...
        @if ($page['section'] == 'create')
            ...
            <!--                        data-id="{{ $template->project_id }}"-->
            <!--                        data-title="{{ $template->project_title }}"-->
            ...
            <!--                        data-title="{{ $template->project_title }}">{{ $template->project_title }}-->
            <!--                    </option>-->
            <!--                @endforeach-->
            <!--            </select>-->
            <!--        </div>-->
