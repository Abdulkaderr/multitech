        ...
        <div class="row">
            ...
            <div class="col-12 m-b-10 billing-mode-only-item">
                ...
                <div class="pull-left">
                    <address>
                        ...
                        <!--@if($bill->bill_type == 'invoice')-->
                        <!--    <h5> <strong>{{ cleanLang(__('lang.invoice')) }} | {{ $bill->formatted_bill_invoiceid }}</strong></h5> -->
                        <!--@elseif($bill->bill_type = 'estimate')-->
                        <!--    <h5> <strong>{{ cleanLang(__('lang.estimate')) }} |{{ $bill->formatted_bill_estimateid }}</strong></h5>-->
                        <!--@endif-->
                </div>
                <!--client address-->
            ...
            @if (auth()->check() && auth()->user()->is_team && !config('visibility.public_bill_viewing'))
                @if (config('visibility.bill_mode') == 'viewing')
                    ...
                    <!--<div class="card card-body invoice-wrapper billing-mode-only-item billing-mode-only-item"-->
                    <!--    id="invoice-wrapper">-->
                    <!--    <h4 class="">{{ cleanLang(__('lang.terms_and_conditions')) }} <span-->
                    <!--            class="align-middle text-themecontrast font-16" data-toggle="tooltip"-->
                    <!--            title="{{ cleanLang(__('lang.not_visisble_to_client')) }}" data-placement="top"><i-->
                    <!--                class="ti-info-alt"></i></span></h4>-->
                    <!--    <div>{!! clean($bill->bill_notes) !!}</div>-->
