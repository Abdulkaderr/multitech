<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <textarea class="w-100" id="item_description" rows="5" name="item_description">{{ $item->item_description ?? '' }}</textarea>
            </div>
        </div>
                ...
                <table class="table table-bordered">
                    <tbody>
                        @foreach ($attachments as $attachment)
                            <tr id="item_attachment_{{ $attachment->attachment_id }}">
                                ...
                                <td class="w-px-40"> <button type="button"
                                        ...
                                        data-url="{{ url('/items/attachments/' . $attachment->attachment_uniqiueid) }}">
        ...
        <div class="form-group row hidden">
            <label class="col-sm-12 text-left control-label col-form-label required">@lang('lang.production_notes')</label>
            <div class="col-sm-12 ">
