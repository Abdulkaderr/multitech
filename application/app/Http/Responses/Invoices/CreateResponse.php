...
class CreateResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the form
                // Omar Alsaied : compacting the variable available_ids to the html
        $html = view('pages/invoices/components/modals/add-edit-inc', compact('page', 'categories', 'tags', 'available_ids'))->render();
        // just the upper line
