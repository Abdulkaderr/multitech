...
class Items extends Controller
{
    ...
    public function __construct(ItemRepository $itemrepo, UserRepository $userrepo, UnitRepository $unitrepo, ProductTaskRepository $producttaskrepo, AttachmentRepository $attachmentrepo)
    {
    ...
    public function index(CategoryRepository $categoryrepo, Category $categorymodel)
    {
        ...
        // Omar Ahmed
        // get product images
        $attachments = \App\Models\Attachment::Where('attachmentresource_type', 'item')
        ->get();
        ...
        if (request()->filled('attachments')) {
            foreach (request('attachments') as $uniqueid => $file_name) {
                $data = [
                    ...
                    'attachmentresource_type' => 'item',
                    'attachmentresource_id' => $item_id,
    ...
    public function edit(CategoryRepository $categoryrepo, $id)
    {
        ...
        $attachments = \App\Models\Attachment::Where('attachmentresource_id', $id)
            ->Where('attachmentresource_type', 'item')
            ->get();
    ...
    public function deleteAttachment()
    {
        ...
        //hide and remove row
        $jsondata['dom_visibility'][] = array(
            'selector' => '#item_attachment_' . $attachment->attachment_id,
