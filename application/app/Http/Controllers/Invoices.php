...
class Invoices extends Controller {
    ...
    public function create(CategoryRepository $categoryrepo) {
        ...
        $payload = [
            ...
            'categories' => $categories,
             // Omar Alsaied: adding this available ids to the creating res payload
            'available_ids' => Invoice::getAvailableIds(),
            // just the upper line
            'tags' => $tags,
        ];
    ...
    public function show($id) {
        ...
        // Omar Alsaied
        $owner = \App\Models\User::Where('clientid', $payload["bill"]->bill_clientid)
        ->Where('account_owner', 'yes')->first();

        $payload["bill"]["owner_email"] = $owner->email;
