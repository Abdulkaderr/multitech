...
class EstimateStoreUpdate extends FormRequest {
    ...
    public function messages() {
        ...
        return [
            ...
            //automation
            'automation_project_title.required_if' => __('lang.project_title') . ' - ' . __('lang.is_required'),
            'automation_invoice_due_date.required_if' => __('lang.automation_invoice_due_date') . ' - ' . __('lang.already_exists'),
        ];
    }
        ...
        if (request('estimate_automation_status') == 'enabled') {
            $rules += [
                'automation_project_title' => [
                    'required_if:automation_create_project,on',
                ],
                'automation_invoice_due_date' => [
                    'required_if:automation_create_invoice,on',
                ],
            ];
        }
